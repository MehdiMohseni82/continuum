...
/// </summary>
public sealed class ResumeService(ContinuumDbContext db, HistoryService history, Continuum.Core.Access.IAccessPolicy policy)
{
    /// <summary>
