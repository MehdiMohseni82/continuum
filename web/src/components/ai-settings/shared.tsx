...
export function FormRow({
  ...
  return (
    <div className="flex flex-col justify-between gap-2 border-b border-gray-100 px-5 py-4 sm:flex-row sm:items-center dark:border-gray-800">
      <label className="flex-1 text-sm font-medium text-gray-700 dark:text-gray-400">
        {label}
      </label>
...
export function DangerButton({
  ...
  return (
    <button
      type="button"
      className="inline-flex h-9 cursor-pointer items-center justify-center gap-1.5 rounded-lg border border-red-400 px-3.5 py-2 text-sm font-medium text-red-500 transition-all hover:bg-red-50 dark:border-red-500/30 dark:hover:bg-red-500/10"
    >
      {icon}
      {children}
    </button>
